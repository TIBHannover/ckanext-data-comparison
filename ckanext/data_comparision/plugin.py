...
class DataComparisionPlugin(plugins.SingletonPlugin):
    ...
    def get_blueprint(self):
        ...
        blueprint.add_url_rule(
            '/data_comparision/base_view/<package_name>/<resource_id>',
            u'base_view',
        ...
        blueprint.add_url_rule(
            '/data_comparision/get_selected_columns',
        ...
        blueprint.add_url_rule(
            '/data_comparision/load_new_page',
            u'load_new_page',
        ...
        blueprint.add_url_rule(
            '/data_comparision/download_file',
            u'download_file',
        ...
        blueprint.add_url_rule(
            '/data_comparision/get_one_resource_plot_data/<resource_id>',
